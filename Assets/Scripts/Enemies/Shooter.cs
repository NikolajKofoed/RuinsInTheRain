...
public class Shooter : MonoBehaviour, IEnemy
{
    ...
    [Tooltip("Adds a time between each bullet in a burst")]
    [SerializeField] private bool stagger;
    [Tooltip("Stagger has to be enabled for oscillate to work properly \n changes direction of bullets to go back and forth")]
    ...
    {
        Vector2 targetDirection = Player2D.Instance.transform.position - transform.position;
